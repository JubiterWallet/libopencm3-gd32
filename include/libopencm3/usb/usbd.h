...
extern const usbd_driver gd32f470_usb_driver;
extern const usbd_driver st_usbfs_v2_usb_driver;
#define otgfs_usb_driver gd32f470_usb_driver
 ...
 * @param callback your desired callback function
 */
extern void usbd_register_set_altsetting_callback(
    usbd_device *usbd_dev, usbd_set_altsetting_callback callback);

/** Registers a non-contiguous string descriptor */
extern void usbd_register_extra_string(usbd_device *usbd_dev, int index,
                                       const char *string);
