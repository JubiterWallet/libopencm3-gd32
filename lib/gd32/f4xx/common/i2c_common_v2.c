 ...
 * @param[in] i2c Unsigned int32. I2C register base address @ref i2c_reg_base.
 */
void i2c_clear_stop(uint32_t i2c) { I2C_ICR(i2c) |= I2C_ICR_STOPCF; }
...
void i2c_send_data(uint32_t i2c, uint8_t data) { I2C_TXDR(i2c) = data; }
 ...
 * @param[in] i2c Unsigned int32. I2C register base address @ref i2c_reg_base.
 */
uint8_t i2c_get_data(uint32_t i2c) { return I2C_RXDR(i2c) & 0xff; }
...
void i2c_set_bytes_to_transfer(uint32_t i2c, uint32_t n_bytes) {
  I2C_CR2(i2c) =
      (I2C_CR2(i2c) & ~I2C_CR2_NBYTES_MASK) | (n_bytes << I2C_CR2_NBYTES_SHIFT);
}

bool i2c_is_start(uint32_t i2c) { return (I2C_CR2(i2c) & I2C_CR2_START); }
...
bool i2c_nack(uint32_t i2c) { return (I2C_ISR(i2c) & I2C_ISR_NACKF); }

bool i2c_busy(uint32_t i2c) { return (I2C_ISR(i2c) & I2C_ISR_BUSY); }

bool i2c_transmit_int_status(uint32_t i2c) {
  return (I2C_ISR(i2c) & I2C_ISR_TXIS);
}

bool i2c_transfer_complete(uint32_t i2c) { return (I2C_ISR(i2c) & I2C_ISR_TC); }

bool i2c_received_data(uint32_t i2c) { return (I2C_ISR(i2c) & I2C_ISR_RXNE); }
 ...
 * @param[in] i2c Unsigned int32. I2C register base address @ref i2c_reg_base.
 */
void i2c_enable_rxdma(uint32_t i2c) { I2C_CR1(i2c) |= I2C_CR1_RXDMAEN; }
 ...
 * @param[in] i2c Unsigned int32. I2C register base address @ref i2c_reg_base.
 */
void i2c_disable_rxdma(uint32_t i2c) { I2C_CR1(i2c) &= ~I2C_CR1_RXDMAEN; }
 ...
 * @param[in] i2c Unsigned int32. I2C register base address @ref i2c_reg_base.
 */
void i2c_enable_txdma(uint32_t i2c) { I2C_CR1(i2c) |= I2C_CR1_TXDMAEN; }
 ...
 * @param[in] i2c Unsigned int32. I2C register base address @ref i2c_reg_base.
 */
void i2c_disable_txdma(uint32_t i2c) { I2C_CR1(i2c) &= ~I2C_CR1_TXDMAEN; }
