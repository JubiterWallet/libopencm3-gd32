...
static usbd_device *gd32f470_usbd_init(void);

static struct _usbd_device usbd_dev;

const struct _usbd_driver gd32f470_usb_driver = {
    .init = gd32f470_usbd_init,
...
static usbd_device *gd32f470_usbd_init(void) {
  ...
  while (OTG_FS_GRSTCTL & OTG_GRSTCTL_CSRST)
    ;
  /*Adjust for gd32f470.*/
  OTG_FS_GCCFG |= OTG_GCCFG_VBUSBSEN | OTG_GCCFG_VBUSASEN | OTG_GCCFG_PWRDWN;
  ...
  OTG_FS_GRXFSIZ = gd32f470_usb_driver.rx_fifo_size;
  usbd_dev.fifo_mem_top = gd32f470_usb_driver.rx_fifo_size;

  /* Unmask interrupts for TX and RX. */
  OTG_FS_GAHBCFG |= OTG_GAHBCFG_GINT;
  OTG_FS_GINTMSK = OTG_GINTMSK_ENUMDNEM | OTG_GINTMSK_RXFLVLM |
                   OTG_GINTMSK_IEPINT | OTG_GINTMSK_USBSUSPM | OTG_GINTMSK_WUIM;
  OTG_FS_DAINTMSK = 0xF;
